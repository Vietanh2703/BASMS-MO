...
class HomePage extends StatelessWidget {
              ...
              children: [
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: Transform.rotate(
                            angle: -0.15, // nghiêng nhẹ giống Figma
                            child: Container(
                              width: 130,
                              height: 130,
                              decoration: BoxDecoration(
                              ...
                              child: ClipOval(
                                child: Image.asset(
                                  "assets/icons/biometric.jpg", // đổi icon cho xịn
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                ...
                GridView.count(
                  ...
                  children: [
                    ...
                    _menuItem(
                      title: "Thông báo",
                      imagePath: "assets/icons/notifications.webp",
  ...
  Widget workStatusChip() {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
      decoration: BoxDecoration(
        color: const Color(0xFFE8F9EE), // nền xanh nhạt
